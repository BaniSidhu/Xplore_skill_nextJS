  ...
  return (
    <main>
     ...
     <div className="text_box">
            <h2>GET READY</h2> <br /><br /><br /><br /> 
            <p id="headtext">TO DISCOVER CAMPUS</p><br /><br />
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit consequuntur corrupti sapiente aut porro
               <br /><br /><br /> <br/> esse blanditiis in quae perspiciatis quo.
            </p>
    ...
    <section className="course">
        ...
        <h1>EXPLORE OUR 60+ <br/><br /><br /> MAJOR PROGRAMS</h1>
